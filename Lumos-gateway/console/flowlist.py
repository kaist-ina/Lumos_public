...
class ConnectionItem(urwid.WidgetWrap):
    ...
    def keypress(self, xxx_todo_changeme, key):
        ...
        # TODO: manual packet learning function call
        elif key == "i":
            dynamic_learner.DynamicLearner.manual_learning_save_one_flow(self.flow)
        elif key == "I":
            dynamic_learner.DynamicLearner.manual_learning_identify_unchangeable()
        elif key == "z":
