                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (operationClone[which]) {
                                ...
                                case "End Recording":
                                    ...
                                    prefEditor.putLong("endTime", System.currentTimeMillis());
                                    long startTime = 0;
                                    startTime = sharedPreferences.getLong("startTime", 0);
                                    long elapsedTime = (System.currentTimeMillis() - startTime) / 1000;
                                    prefEditor.putLong("elapsedTime", elapsedTime);

                                    //prefEditor.putLong("elapsedTime", )
                                    prefEditor.commit();
                                ...
                                case "Resume Last Recording":
                                    ...
                                    break;
                                case "Quit Lumos":
                                    Toast.makeText(context, "quit Lumos", Toast.LENGTH_SHORT).show();
                                    try {
