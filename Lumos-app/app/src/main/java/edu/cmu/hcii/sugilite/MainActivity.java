...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // if this activity was ran by push message.
        if (intent.getExtras() != null)
            targetApp = intent.getExtras().getString("targetApp");
        ...
        setTitle("Teaching Lumos-gateway");
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                builder.setMessage("Specify the name for your new script (ex: appname semantics)")
                        .setView(scriptName)
                        .setPositiveButton("Start Recording", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {

                                //if does not enable accessibility service.
                                ...
                                //if do enable accessibility service.
                                // scriptName is from user (Text Control)
     ...
     */
    private void setUpScriptList(String target){
        ...
        if (target != null) {
            int i = 0;
            for (String resultname : displayNames) {
        ...
        if (targetidx != -1) {
            Globaldata.setauto(true);
            scriptList.performItemClick(scriptList.getAdapter().getView(targetidx, null, null), targetidx, scriptList.getAdapter().getItemId(targetidx));
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        //interoperation manager
        if (id == R.id.action_interoperation_configure)
        {
