...
public class Constants
{
	...
	/*(Debug)*/public static boolean printResultOfFrontend = true/*false*/; // Print final Frontend result
	
	public static int maxTRE = 5000; // limit of # TRE
	public static int maxFrontendRunningTime = 10; // timeout of frontend
	public static TimeUnit frontendTimeUnit = TimeUnit.MINUTES;
	public static int maxMergingTime = 10; // timeout of merging
	public static TimeUnit mergingTimeUnit = TimeUnit.MINUTES;
	...
	public static TimeUnit backendTimeUnit = TimeUnit.MINUTES;
    ...
    /***************************************/
    /***        IoT Interoeprability     ***/
    /***************************************/
    public static boolean FindingEventHandler = false;
	...
	public static String SpecificEP= null;
			//"<com.obsidian.v4.data.c.p: java.lang.Object loadInBackground()>" nest
			//"<com.netflix.mediaclient.service.mdx.MdxAgent: void switchPlaybackFromTarget(java.lang.String,int)>";
			//"<com.belkin.cybergarage.wrapper.UpnpDeviceList: java.lang.String deleteNotifyRule(java.lang.String[])>"
	...
	/***         For only Retrofit       ***/
	/***************************************/
	public static boolean onlyRetrofit = false;
	//it didn't merge same URLs when Extractocol outputs request signatures
	public static boolean splitURLsforEachEP = true;
