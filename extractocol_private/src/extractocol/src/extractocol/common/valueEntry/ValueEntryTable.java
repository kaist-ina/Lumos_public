...
public class ValueEntryTable implements Serializable {
	...
	public void addMapValue(String varORheap, String key, String value, boolean toReference){
		addValueEntry(varORheap, key, value, SOURCE_TYPE.MAP, toReference);
	}
	...
	public void AppendURLPathToStringBuilder(String varORheap, String val){
		String _string;
		_string = getRefinedConstant(val.toString());
