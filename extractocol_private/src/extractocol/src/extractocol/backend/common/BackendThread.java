...
public class BackendThread implements Runnable {
	...
	public String getWinixRequestBodyClass() {
		return winixRequestBodyClass;
	}

	public void setWinixRequestBodyClass(String winixRequestBodyClass) {
		this.winixRequestBodyClass = winixRequestBodyClass;
	}

	String winixRequestBodyClass;
