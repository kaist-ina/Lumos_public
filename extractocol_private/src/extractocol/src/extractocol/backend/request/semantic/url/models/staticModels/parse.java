...
//			System.out.println("URL parse : " + spb.CurrentPB.varTable.GenRegex(spb.sie.getArg(0).toString()));
			//Constants.BFTResultAlreadyApplied = true;

			spb.CurrentPB.varTable.OverWriteValueEntryListFromSrcToDest(spb.CurrentPB.strDest, spb.sie.getArg(0).toString(), false);
		}
	}
}
