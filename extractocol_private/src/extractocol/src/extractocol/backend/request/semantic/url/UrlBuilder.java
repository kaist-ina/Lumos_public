...
public class UrlBuilder extends SignatureBuilder_Request {
	...
	public enum MethodNames {
		...
		tourl, trim, url, valueof, write, getvalue, getkey, keyset, constructcollectiontype, convertvalue, frombody, a //AsyncHttpClient getUrlWithQueryString
		, sendsync, setparams, getparams //PubnubLib
		, putopt, setbody, tojson, setdata
		//Cybergarage
		, getaction, setargument,postcontrolaction,
        //UIfinder
        findviewbyid,setOnClickListener, setOnSeekBarChangeListener, setOnTouchListener
	}
	...
	public static void initSemanticModels() {
		methodlist = Arrays.asList("<init>", "append", "setEntity", "setHeader", "getJSONFromPost", "getJSONFromUrl",
				...
				"constructCollectionType", "convertValue", "fromBody", "getUrlWithQueryString");
		...
		SemanticModel = Arrays.asList("<android.content.res.AssetManager: java.io.InputStream open(java.lang.String)>",
				...
				// for AsyncHttpClient
				"<com.loopj.android.http.a: java.lang.String a(boolean,java.lang.String)>",
				// for Pubnub
				"<com.insteon.hub2.util.PubNubHelper: com.insteon.hub2.bean.Hub2Response sendSync(com.insteon.hub2.bean.Hub2Command)>",
				"<com.insteon.hub2.bean.Hub2Command: void setParams(java.util.Map)>",
				"<com.insteon.hub2.bean.Hub2Command: java.util.Map getParams()>",
		        // for Netflix
		        "<org.json.JSONObject: org.json.JSONObject putOpt(java.lang.String,java.lang.Object)>",
		        "<com.netflix.mediaclient.service.logging.customerevents.legacy.MdxCustomerEvent: void <init>(java.lang.String,com.netflix.mediaclient.webapi.AuthorizationCredentials,java.lang.String)>",
		        "<org.json.JSONArray: java.lang.String toString()>",

                // for winix
                "<com.winix.android.smartair.nike.network.http.data.RequestWinix: void setBody(com.winix.android.smartair.nike.network.http.data.ReqBody)>",
		        "<com.winix.android.smartair.nike.network.HTTPManager: boolean post(java.lang.String,int,java.lang.String,com.umc.simba.android.framework.networks.http.SBHttpHeader,java.lang.String,boolean,java.lang.String)>",

                // for nest
                "<com.obsidian.v4.data.cz.service.z: void <init>(java.lang.String,com.obsidian.v4.data.cz.service.NetRequest$RequestMethod)>",
                "<com.obsidian.v4.data.cz.service.z: com.obsidian.v4.data.cz.service.z a(org.json.JSONObject)>",
		        "<com.obsidian.v4.data.cz.service.z: com.obsidian.v4.data.cz.service.z a(java.lang.String,java.lang.String)>",

				// for harmony
				"<com.logitech.harmonyhub.sdk.Request: void <init>(java.lang.String,int)>",
				"<com.logitech.harmonyhub.sdk.Request: void setData(java.lang.String,java.lang.String)>",

				//wemo
				"<com.belkin.cybergarage.wrapper.UpnpDeviceList: boolean setArgument(org.cybergarage.upnp.Action,java.lang.String[],java.lang.String[])>",
				"<org.cybergarage.upnp.Action: java.lang.String postControlAction()>",
				"<org.cybergarage.upnp.Device: org.cybergarage.upnp.Action getAction(java.lang.String)>",
	...
	public String AnalyzeExpression(InstanceInvokeExpr iie, HashMap<String, ArrayList<BFNode>> BFTtable, Unit ut,
		...
		try{
			...
			case put:
				...
				break;
            case tojson:
                SemanticDecorator.setBaseModel(new tojson());
                break;
			case setdata:
				SemanticDecorator.setBaseModel(new setdata());
				break;
			case appendqueryparameter:
				SemanticDecorator.setBaseModel(new appendQueryParameter());
				break;
            case setbody:
                SemanticDecorator.setBaseModel(new setbody());
                break;
			case openconnection:
			...
			case frombody: 
				...
				break;
			case setparams:
				SemanticDecorator.setBaseModel(new setParams());
				break;
			case getparams:
				SemanticDecorator.setBaseModel(new getParams());
				break;
			case sendsync:
				SemanticDecorator.setBaseModel(new sendSync());
				break;
			case putopt:
			    SemanticDecorator.setBaseModel(new putopt());
				break;
			case getaction:
				SemanticDecorator.setBaseModel(new getaction());
				break;
			case postcontrolaction:
				SemanticDecorator.setBaseModel(new postcontrolaction());
				break;
			case setargument:
				SemanticDecorator.setBaseModel(new setargument());
				break;
			default:
	...
	public void AnalyzeExpression(StaticInvokeExpr sie, HashMap<String, ArrayList<BFNode>> BFTtable, Unit ut,
		...
		try{
			...
			case addqueryparameters:
				...
				break;
			case a:
				SemanticDecorator.setBaseModel(new a());
				break;
			default:
				SemanticDecorator
