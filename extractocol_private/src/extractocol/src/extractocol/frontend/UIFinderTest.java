...
public class UIFinderTest {
    ...
    {
        UIFinderTest.ipcManager = ipcManager;
    }
    public static IIPCManager getIPCManager()
    {
        return UIFinderTest.ipcManager;
    }
...
//				"--repeatCount", Integer.toString(repeatCount),
    ...
    private static InfoflowResults runAnalysis(final String fileName, final String androidJar) {
        try {
            ...
            final UIFinderSetupApplication app;


            if (null == ipcManager)
            {
                app = new UIFinderSetupApplication(androidJar, fileName);
            }
            else
            {
                app = new UIFinderSetupApplication(androidJar, fileName, ipcManager);
            }
