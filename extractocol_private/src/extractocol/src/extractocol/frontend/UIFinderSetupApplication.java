...
public class UIFinderSetupApplication {
     ...
     */
    public UIFinderSetupApplication(String androidJar, String apkFileLocation) {
    ...
    public InfoflowResults runInfoflow(ResultsAvailableHandler onResultsAvailable) {
        ...
        UIFinderForwardInfoflow info;

        if (cfgFactory == null)
            info = new UIFinderForwardInfoflow(androidJar, forceAndroidJar, null,
                    new DefaultPathBuilderFactory(config.getPathBuilder(),
                            config.getComputeResultPaths()));
        else
            info = new UIFinderForwardInfoflow(androidJar, forceAndroidJar, cfgFactory,
                    new DefaultPathBuilderFactory(config.getPathBuilder(),
                            config.getComputeResultPaths()));
